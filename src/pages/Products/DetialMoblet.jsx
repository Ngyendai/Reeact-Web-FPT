...
import { Md360, MdScreenShare } from "react-icons/md";
import {
  FaMedal,
  FaShippingFast,
  FaMapMarkerAlt,
              ...
              >
                <div className="container__box__information__details__left">
                  ...
                  <div className="container__box__information__details__items">
                    <div className="container__box__information__details__item">
                      <p>{product.detialtext1}</p>
                    </div>
                    <div className="container__box__information__details__item">
                      <p>{product.detialtext2}</p>
                    </div>
                    <div className="container__box__information__details__item">
                      <p>{product.detialtext3}</p>
                    </div>
                    <div className="container__box__information__details__item">
                      <p>{product.detialtext4}</p>
                    </div>
                    <div className="container__box__information__details__item">
                      <p>{product.detialtext5}</p>
                    </div>
                    <p>
                ...
                <div className="container__box__information__details__right">
                  ...
                  <div className="container__box__information__details__right__img">
                    ...
                    <div onClick={() => setPreviewImg(product.imagesdetial4)}>
                      <img src={product.imagesdetial4} />
                    </div>
                    <div onClick={() => setPreviewImg(product.imagesdetial5)}>
                      <img src={product.imagesdetial5} />
                    </div>
                    <div onClick={() => setPreviewImg(product.imagesdetial6)}>
                      <img src={product.imagesdetial6} />
                    </div>
                  </div>
